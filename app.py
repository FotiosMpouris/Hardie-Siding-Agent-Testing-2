...
if st.button("Generate New Video Transcript (Introductory/General)"):
    with st.spinner("Generating new video transcript..."):
        general_transcript = video_transcript_agent("")  # Passing an empty string for new_project_info
    st.subheader("New Video Transcript Template:")
    st.text_area("Generated Transcript", general_transcript, height=300)
    st.download_button(
        label="Download New Transcript",
        data=general_transcript,

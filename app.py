...
# Old feature: Generate video transcript
if st.button("Generate New Video Transcript (Old Method)", key="generate_old_transcript"):
    if folder_id:
...
# New feature: Input field for new project information (moved to bottom)
st.header("New Project Information")
new_project_info = st.text_area("Please Enter New Project Information", height=200)

# New feature: Generate new script
